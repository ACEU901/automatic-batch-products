...
public class ExcelTransferService {
    ...
    public static TransferResult procesarArchivo(File archivoEntrada, JProgressBar barraProgreso) throws IOException {
    ...
    private static TransferResult procesarExcel(File archivo, JProgressBar barraProgreso) throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(archivo);
            ...
            int cantidad = registrosCompletos.size() / 2;
